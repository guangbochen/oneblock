...
// ServiceController interface for managing MLServe resources.
type ServiceController interface {
	generic.ControllerInterface[*v1.MLServe, *v1.ServiceList]
}

// ServiceClient interface for managing MLServe resources in Kubernetes.
type ServiceClient interface {
	generic.ClientInterface[*v1.MLServe, *v1.ServiceList]
}

// ServiceCache interface for retrieving MLServe resources in memory.
type ServiceCache interface {
	generic.CacheInterface[*v1.MLServe]
}

type ServiceStatusHandler func(obj *v1.MLServe, status v1.ServeStatus) (v1.ServeStatus, error)

type ServiceGeneratingHandler func(obj *v1.MLServe, status v1.ServeStatus) ([]runtime.Object, v1.ServeStatus, error)
...
func (a *serviceStatusHandler) sync(key string, obj *v1.MLServe) (*v1.MLServe, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *serviceGeneratingHandler) Remove(key string, obj *v1.MLServe) (*v1.MLServe, error) {
	if obj != nil {
		return obj, nil
	}
...
func (a *serviceGeneratingHandler) Handle(obj *v1.MLServe, status v1.ServeStatus) (v1.ServeStatus, error) {
